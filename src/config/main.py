...
VALIDATION_DATA_BASELINE_FILE = os.path.join(
    PROCESSED_PATH, VALIDATION_DATA_BASELINE_NAME
)

VALIDATION_DATA_TECHNICAL_NAME = "validation_data_technical.csv"
VALIDATION_DATA_TECHNICAL_FILE = os.path.join(
    PROCESSED_PATH, VALIDATION_DATA_TECHNICAL_NAME
)
