...
def prepare_models(train_data_baseline, valid_data_baseline, train_data_technical, valid_data_technical):
    logger.info("Starting model preparation")
    try:

        baseline_results = evaluate_models(train_data_baseline, valid_data_baseline, dataset_type="Baseline")
        technical_results = evaluate_models(train_data_technical, valid_data_technical, dataset_type="Technical")
